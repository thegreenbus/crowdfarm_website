            ...
            <div class="container max-w-lg px-4 py-32 mx-auto text-left md:max-w-none md:text-center">
                <h1 class="text-5xl font-extrabold leading-10 tracking-tight text-left text-gray-900 md:text-center sm:leading-none md:text-6xl lg:text-7xl">
                    <span class="inline md:block">Farmer Fundraising </span> <span
                        class="relative mt-2 text-transparent bg-clip-text bg-gradient-to-br from-indigo-600 to-indigo-500 md:inline-block">& <br/> Agriculture Investment</span>
                </h1>
                <div class="mx-auto mt-5 text-gray-500 md:mt-12 md:max-w-lg md:text-center lg:text-lg">Farmer
                    fundraising is
                    essential because agriculture is the future
                </div>
                ...
                <div class="flex flex-wrap items-center sm:-mx-3">
                    <div class="w-full md:w-1/2 md:px-3">
                        <div
                            ...
                            <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                                <span class="block xl:inline">Help a Farmer in need to</span>
                                <span class="block text-indigo-600 xl:inline">Make a change!</span>
                            </h1>
                            <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">Grow
                                Agriculture
                                in Kenya</p>
                    ...
                    <div class="w-full md:w-1/2">
                        <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                            <img
                                src="https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80">
                        </div>
                    </div>
                </div>
            </div>
...
border-indigo-600 items-center justify-between col-span-4 px-8 py-12 space-y-4 overflow-hidden bg-gray-100 sm:rounded-xl">
                            <div
                                class="flex w-64 items-center rounded-lg shadow-lg mb-4 flex bg-indigo-500 p-4 text-white">
                                <div class="w-64">
                            ...
                            <p class="text-base text-center text-gray-500">{{ Str::limit($campaign->description, 100) }}
                                !</p>
                ...
                <div
                    ...
                    <div class="box-border flex-1 text-center border-solid sm:text-left">
                        ...
                        <p class="mt-2 text-xl text-left text-gray-900 border-0 border-gray-200 sm:text-2xl">
                            CrowdFarm is the best place to fundraise, whether you are an individual, group, or
                            organization.
                        </p>
                    </div>
                    <a href="{{ route('register') }}"
            ...
            <div class="max-w-6xl px-12 mx-auto bg-gray-100 md:px-16 xl:px-10">
                <div class="flex flex-col items-center lg:flex-row">
                    <div class="flex flex-col items-start justify-center w-full h-full pr-8 mb-10 lg:mb-0 lg:w-1/2">
                        <p class="mb-2 text-base font-medium tracking-tight text-indigo-500 uppercase">Our customers
                            love our product</p>
                        ...
                        <blockquote
                            ...
                            <div class="flex flex-col pr-8">
                                ...
                                <h3 class="pl-12 mt-3 text-sm font-medium leading-5 text-gray-800 truncate sm:text-base lg:text-sm lg:text-base">
                                    Angelita
                                    <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- CEO CrowdFarm</span>
                                </h3>
                            </div>
                            <img class="flex-shrink-0 w-20 h-20 bg-gray-300 rounded-full xl:w-24 xl:h-24"
                                 src="https://res.cloudinary.com/dcsawngwg/image/upload/v1649638283/photo5951916854064822047_q0tool.jpg"
                                 alt="">
                        </blockquote>
                        <blockquote
                            ...
                            <div class="flex flex-col pr-10">
                                ...
                                <h3 class="pl-12 mt-3 text-sm font-medium leading-5 text-gray-800 truncate sm:text-base lg:text-sm lg:text-base">
                                    Mash
                                    <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- Farmersoko</span>
                                </h3>
                                <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                            </div>
                            <img class="flex-shrink-0 w-24 h-24 bg-gray-300 rounded-full"
                                 src="https://res.cloudinary.com/dcsawngwg/image/upload/v1649638288/photo5951916854064822048_ppmdk3.jpg"
                                 alt="">
                        </blockquote>
                        <blockquote
                            class="flex items-center justify-between w-full col-span-1 p-6 mt-4 bg-white rounded-lg shadow">
                            <div class="flex flex-col pr-10">
                                ...
                                <h3 class="pl-12 mt-3 text-sm font-medium leading-5 text-gray-800 truncate sm:text-base lg:text-sm lg:text-base">
                                    John Kamau
                                    <span class="mt-1 text-sm leading-5 text-gray-500 truncate">-Farmer</span>
                                </h3>
                                <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                            </div>
                            <img class="flex-shrink-0 w-24 h-24 bg-gray-300 rounded-full"
                                 src="https://images.unsplash.com/photo-1545830790-68595959c491?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTV8fGZhcm1lcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
                                 alt="">
                        </blockquote>
                    </div>
                </div>
