            ...
            <div class="flex flex-wrap items-center -mx-3">
                <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div class="w-full lg:max-w-md">
                        <h2 class="mb-4 text-3xl font-bold leading-tight tracking-tight sm:text-4xl font-heading">How
                            CrowdFarm Works!</h2>
                        <p class="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">
                            Both the investor and the fund raiser must trust a third party to handle their money
                            correctly, which is why Crowd Farm is the finest place to fundraise. However, under our
                            approach, all monies are transmitted directly from the investor to the fund raiser, with no
            ...
            <div
                ...
                <div class="box-border flex-1 text-center border-solid sm:text-left">
                    ...
                    <p class="mt-2 text-xl text-left text-gray-900 border-0 border-gray-200 sm:text-2xl">
                        CrowdFarm is the best place to fundraise
                    </p>
                </div>
